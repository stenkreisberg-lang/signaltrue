...
export const FUNNEL_EVENT_NAMES = [
  ...
  'control_assessment_viewed',
  'control_assessment_started',
  'control_assessment_completed',
  'control_assessment_lead_confirmed',
  'did_control_work_viewed',
  'did_control_work_completed',
  'did_control_work_plan_copied',
  'ask_signaltrue_viewed',
  'ask_signaltrue_question_submitted',
  'ask_signaltrue_answer_received',
  'control_review_pack_shared',
  'control_review_pack_printed',
  'signaltrue_labs_viewed',
  'diagnostic_started',
