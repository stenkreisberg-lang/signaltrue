  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-20">
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-soft border border-brand-soft mb-6">
                ...
                <span className="text-caption font-medium text-brand">Privacy by architecture</span>
              </div>
              <h1 className="text-display sm:text-display lg:text-display font-display font-bold mb-6 text-[#0F172A]">
                Privacy is not a feature. <span className="text-brand">It is the foundation.</span>
              </h1>
        ...
        <section className="py-12 bg-brand-softer border-b border-brand-soft">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  <div
                    key={item}
                    className="p-4 rounded-container bg-white border border-brand-soft text-center"
                  >
                    <CheckCircle className="w-5 h-5 text-brand mx-auto mb-2" />
                    <span className="text-caption font-semibold text-brand-hover">{item}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <h2 className="text-section sm:text-display font-display font-bold mb-4 text-[#0F172A]">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {whatWeUse.map((item, index) => (
                  <div
                    key={index}
                    className="p-6 rounded-container bg-[#F8FAFC] border border-[#E2E8F0]"
                  >
                    <div className="p-3 rounded-container bg-brand-soft w-fit mb-4">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#FEE2E2] border border-[#B91C1C]/20 mb-6">
                  ...
                  <span className="text-caption font-medium text-[#B91C1C]">Hard limits</span>
                </div>
                <h2 className="text-section sm:text-display font-display font-bold mb-4 text-[#0F172A]">
              ...
              <div className="p-8 rounded-container bg-white border border-[#E2E8F0]">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {employeeTransparency.map((item, index) => (
                  ...
                  >
                    ...
                    <p className="text-caption text-[#475569] pl-8">{item.description}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="py-20 lg:py-24 bg-[#F8FAFC] border-y border-[#E2E8F0]">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="p-6 rounded-container bg-white border border-[#E2E8F0] text-center">
                  <div className="p-3 rounded-container bg-[#DBEAFE] w-fit mx-auto mb-4">
          ...
          <div className="container mx-auto px-6">
            <div className="mx-auto max-w-5xl">
              <div className="max-w-3xl">
                <p className="mb-4 text-caption font-semibold uppercase tracking-wider text-brand">
        ...
        <section className="border-y border-[#E2E8F0] bg-white py-20 lg:py-24">
          <div className="container mx-auto px-6">
            <div className="mx-auto max-w-5xl">
              ...
              <div className="mt-8 rounded-container border border-amber-200 bg-amber-50 p-6 text-caption leading-6 text-amber-950">
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-body text-[#334155] mb-8 max-w-xl mx-auto">
                ...
                <a href="mailto:privacy@signaltrue.ai" className="text-brand underline">
