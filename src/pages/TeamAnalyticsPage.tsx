...
const analyticsPatterns = [
  {
    ...
    whatWeObserve: [
      ...
      'Manager calendar density',
    ],
    whyItMatters:
      'High system load leaves less time for actual work. When coordination consumes too much capacity, execution slows even if everyone is working hard.',
  },
  {
    icon: Focus,
    ...
    whatWeObserve: [
      ...
      'Notification and meeting patterns',
      'Fragmented workdays',
      'Calendar gaps too short for meaningful work',
    ],
    whyItMatters:
      'Fragmented attention degrades quality and increases stress. People work longer hours but produce less valuable work.',
  },
  {
    icon: TrendingDown,
    ...
    whatWeObserve: [
      ...
      'Bottleneck work patterns',
      'After-hours activity trends',
      'Repeated coordination delays',
