...
const analyticsPatterns = [
  {
    ...
    whyItMatters: "High system load forces work into evenings and weekends. It's the invisible tax on execution that surveys don't capture.",
  },
  {
    icon: Focus,
    ...
    whyItMatters: "Fragmented attention degrades quality and increases stress. People work longer hours but produce less value.",
  },
  {
    icon: TrendingDown,
    ...
    whyItMatters: "When effort stays high but execution slows, the team is compensating for structural problems. This predicts burnout and attrition.",
  },
];
          ...
          <div className="container mx-auto px-6 relative">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-bold mb-6">
                What Teams Absorb{" "}
                <span className="text-gradient">Before They Break</span>
              </h1>
              <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-8">
                SignalTrue reveals the hidden patterns that predict team strain, 
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
                SignalTrue explains patterns at the team and system level. 
                We never surface individual names, read message content, or score productivity.
              </p>
