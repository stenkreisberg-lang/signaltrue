    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <main className="pt-20">
        <section className="border-b border-[#E2E8F0] bg-white py-16 lg:py-24">
          <div className="container mx-auto px-6">
            <div className="mx-auto max-w-5xl text-center">
              ...
              <p className="mx-auto mt-6 max-w-4xl text-xl leading-8 text-[#475569]">
            ...
            <div className="mx-auto max-w-5xl">
              ...
              <div className="mt-9 grid gap-4 md:grid-cols-2">
                {reviewItems.map((item) => (
                  <div key={item} className="flex gap-3 rounded-2xl bg-[#F8FAFC] p-5">
        ...
        <section className="bg-[#0F172A] py-16 text-white lg:py-20">
          <div className="container mx-auto grid max-w-6xl items-start gap-10 px-6 lg:grid-cols-[0.9fr_1.1fr]">
            <div>
              ...
              <h2 className="mt-5 text-3xl font-bold">Privacy boundaries</h2>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {privacyBoundaries.map((boundary) => (
                <div key={boundary} className="flex gap-3 rounded-xl bg-white/5 p-4">
                  <CheckCircle2 className="mt-0.5 h-5 w-5 shrink-0 text-[#34D399]" />
                  <span className="text-sm leading-6 text-[#E2E8F0]">{boundary}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="request-review" className="border-t border-[#E2E8F0] bg-white py-16 lg:py-20">
          <div className="container mx-auto px-6">
            <div className="mx-auto max-w-3xl rounded-3xl border border-[#E2E8F0] bg-[#F8FAFC] p-7 md:p-10">
