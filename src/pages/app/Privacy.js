...
function Privacy() {
  ...
  const fetchTransparencyLog = async () => {
    ...
    try {
      ...
      const response = await fetch(`${apiBase}/api/privacy/transparency-log`, {
        headers: {
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            border: 'none',
            borderBottom:
              activeTab === 'transparency' ? '2px solid #2563eb' : '2px solid transparent',
            marginBottom: '-2px',
            cursor: 'pointer',
            transition: 'all 0.2s',
          }}
      ...
      {activeTab === 'transparency' && (
        <div>
          ...
          >
            ...
            >
              <strong>Admin View:</strong> This log shows every data pull SignalTrue makes from your
              connected integrations. All data is aggregated to team level only.
            </p>
          </div>
                ...
                <tbody>
                  {transparencyLog.map((entry, idx) => (
                    <tr
                      ...
                      style={{
                        borderBottom:
                          idx < transparencyLog.length - 1 ? '1px solid #e5e7eb' : 'none',
                      }}
                    >
                      <td
                        style={{
