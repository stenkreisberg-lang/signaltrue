          ...
          <div className="container mx-auto px-6">
            <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-2">
              <div className="rounded-2xl bg-white p-7 shadow-sm">
                <ShieldCheck className="h-7 w-7 text-[#047857]" aria-hidden="true" />
                <h2 className="mt-4 text-2xl font-bold text-[#0F172A]">Pilot success measures</h2>
                <ul className="mt-5 space-y-3">
                  {successMeasures.map((item) => (
                    <li key={item} className="flex gap-3 text-sm leading-6 text-[#475569]">
                      <CheckCircle2
                        className="mt-1 h-4 w-4 shrink-0 text-[#047857]"
                        aria-hidden="true"
                      />
                      {item}
                    </li>
              ...
              <div className="rounded-2xl bg-[#0F172A] p-7 text-white">
                ...
                <div className="mt-6 grid grid-cols-2 gap-3 text-sm">
                  {[
                    ...
                    <div key={item} className="rounded-xl border border-[#334155] bg-[#1E293B] p-3">
                      {item}
                    </div>
                  ))}
                </div>
