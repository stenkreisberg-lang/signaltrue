...
const SignalCard = ({ signal, onViewDetails, onAssign, onUpdateStatus }) => {
  ...
  return (
    <Card
      className="hover:border-emerald-700 transition-colors cursor-pointer"
          ...
          <div className="flex items-start justify-between gap-4 mb-3">
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-2 mb-2">
                <Badge variant={severity.toLowerCase()} icon={getSeverityIcon(severity)}>
                  {severity}
                </Badge>
                <Badge
                ...
                <Badge variant={formatStatus(status)}>{status}</Badge>
              </div>
            </div>
            ...
            <div className="mb-3 p-3 bg-slate-900/50 rounded-lg border border-slate-700">
              ...
              <div className="grid grid-cols-3 gap-4 text-sm">
                ...
                <div>
                  ...
                  <div className="text-slate-300">{deviation.baselineValue?.toFixed(1)}</div>
                </div>
                <div>
