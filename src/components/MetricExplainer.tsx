...
export const METRIC_EXPLANATIONS: Record<string, MetricExplanation> = {
  ...
  afterHoursRate: {
    ...
    interpretation: {
      low: '<10%: Within the usual range',
      medium: '10-20%: Moderate after-hours activity',
      high: '>20%: Sustained after-hours activity — may warrant investigation',
    },
  ...
  overloadRisk: {
    ...
    interpretation: {
      low: '<35: Little change from baseline',
      medium: '35-65: Moderate work-pattern change',
      high: '>65: Substantial, persistent change — may warrant investigation',
    },
