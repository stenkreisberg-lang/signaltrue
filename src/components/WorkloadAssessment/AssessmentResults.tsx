...
export const AssessmentResults: React.FC<AssessmentResultsProps> = ({
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-card rounded-container border border-border/50 p-8">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="text-right">
            <p className="text-caption text-muted-foreground">Workload Risk Index</p>
            <p className="text-lead font-display font-bold text-foreground">
        ...
        <div className="text-center py-6 border-y border-border/50 mb-6">
          <h3 className="text-lead font-display font-semibold text-foreground mb-2">
          ...
          <p className="text-section sm:text-display font-display font-bold text-foreground">
            {formatCostRange(result.costBreakdown.totalCostLow, result.costBreakdown.totalCostHigh)}
          </p>
          <p className="text-caption text-muted-foreground mt-2">per year</p>
        </div>
        ...
        <div className="space-y-3 mb-6">
          ...
          <ul className="space-y-2">
            {result.insights.map((insight, index) => (
              <li key={index} className="flex items-start gap-3 text-caption text-muted-foreground">
                <span className="flex-shrink-0 w-5 h-5 rounded-full bg-primary/10 text-primary text-caption flex items-center justify-center font-medium">
                  {index + 1}
                </span>
                {insight}
              </li>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-4 rounded-container bg-secondary/30">
          <div className="text-center">
            <Clock className="w-5 h-5 text-primary mx-auto mb-1" />
            <p className="text-caption text-muted-foreground">Meeting Load</p>
          ...
          <div className="text-center">
            ...
            <p className="text-caption text-muted-foreground">Fragmentation</p>
            <p className="font-semibold text-foreground">
          ...
          <div className="text-center">
            ...
            <p className="text-caption text-muted-foreground">After-Hours</p>
            <p className="font-semibold text-foreground">
          ...
          <div className="text-center">
            ...
            <p className="text-caption text-muted-foreground">Focus Loss</p>
            <p className="font-semibold text-foreground">
      ...
      {/* Step 2: Email Gate */}
      {!showFullBreakdown && (
        <div className="bg-card rounded-container border border-primary/30 p-8">
      ...
      {showFullBreakdown && (
        <>
          <div className="bg-card rounded-container border border-border/50 p-8">
            <h3 className="text-lead font-display font-bold text-foreground mb-6 flex items-center gap-2">
            ...
            <div className="space-y-6">
              {/* Meeting Costs */}
              <div className="p-4 rounded-container bg-secondary/30">
              ...
              {/* Meeting Waste */}
              <div className="p-4 rounded-container bg-warning/5 border border-warning/20">
                <div className="flex items-center justify-between mb-2">
              ...
              {/* Turnover Exposure */}
              <div className="p-4 rounded-container bg-destructive/5 border border-destructive/20">
                <div className="flex items-center justify-between mb-2">
              ...
              {/* Total */}
              <div className="p-4 rounded-container bg-primary/5 border border-primary/30">
                <div className="flex items-center justify-between mb-2">
                  <span className="font-semibold text-foreground">
          ...
          {/* Transparency Block */}
          <div className="bg-secondary/20 rounded-container border border-border/50 p-6">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 text-caption">
              <div className="p-3 rounded-control bg-background">
            ...
            <p className="text-caption text-muted-foreground mt-4 p-3 rounded-control bg-primary/5 border border-primary/20">
          ...
          {/* CTA Section */}
          <div className="bg-hero-gradient rounded-container p-8 text-center relative overflow-hidden">
            <div className="absolute inset-0 bg-glow opacity-20" />
            <div className="relative">
              <h3 className="text-lead font-display font-bold text-foreground mb-4">
