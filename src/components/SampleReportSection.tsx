...
const SampleReportSection = () => (
  <section className="bg-white py-16 lg:py-20">
    <div className="container mx-auto px-6">
      <div className="mx-auto grid max-w-5xl items-center gap-10 rounded-3xl border border-[#E2E8F0] bg-[#F8FAFC] p-6 sm:p-10 lg:grid-cols-2">
        <div>
        ...
        <div className="rounded-2xl border border-[#E2E8F0] bg-white p-6 shadow-card">
          <div className="mb-5 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-[#64748B]">Decision status: awaiting review</p>
            </div>
          </div>
          <ul className="space-y-3">
            {[
              ...
              <li key={item} className="flex gap-3 text-sm text-[#334155]">
