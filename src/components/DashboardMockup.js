      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '40px' }}>
        ...
        <div>
          ...
          >
            ...
            >
              This signal reflects aggregated changes in how work is coordinated, not individual
              performance.
            </div>
            ...
            >
              <div>
                <div style={{ fontSize: '12px', color: '#94a3b8', marginBottom: '4px' }}>
                  The Signal (vs 3-Month Benchmark)
                </div>
                <div style={{ fontSize: '15px' }}>
                  Deep work blocks dropped by{' '}
                  <span style={{ color: '#f87171', fontWeight: '700' }}>-40%</span> compared to Q3
                  average.
                </div>
              </div>
              <div>
                ...
                <div style={{ fontSize: '15px' }}>
                  ...
                  >
                    Context added: Reorganization (2 weeks ago)
                  </span>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <p style={{ margin: '0 0 15px 0', fontSize: '14px', lineHeight: '1.5' }}>
                Initiate a "Meeting Audit" for the Engineering team. Consider implementing a
                "No-Meeting Wednesday" to restore focus blocks.
              </p>
          ...
          >
            ...
            <div style={{ fontSize: '15px', lineHeight: '1.5', marginBottom: '15px' }}>
              After-hours messaging volume has decreased by{' '}
              <span style={{ color: '#34d399', fontWeight: '700' }}>15%</span> following the
              "Disconnect Policy" rollout.
            </div>
        ...
        <div>
          ...
          >
            <h4 style={{ margin: '0 0 15px 0', fontSize: '14px', color: 'white' }}>
            ...
            >
              <div
                style={{ width: '20%', height: '40%', background: '#334155', borderRadius: '2px' }}
              ></div>
              <div
                style={{ width: '20%', height: '50%', background: '#334155', borderRadius: '2px' }}
              ></div>
              <div
                style={{ width: '20%', height: '45%', background: '#334155', borderRadius: '2px' }}
              ></div>
              <div
                style={{ width: '20%', height: '70%', background: '#334155', borderRadius: '2px' }}
              ></div>
              <div
                style={{ width: '20%', height: '85%', background: '#f87171', borderRadius: '2px' }}
              ></div>
            </div>
          ...
          >
            <h4 style={{ margin: '0 0 10px 0', fontSize: '13px', color: '#94a3b8' }}>
              Privacy & Aggregation
            </h4>
            <p style={{ fontSize: '12px', color: '#64748b', lineHeight: '1.5', margin: 0 }}>
              All data displayed is aggregated at the team level (min. group size: 5). No individual
              messages or calendar events are accessible.
            </p>
            <p
              style={{
                fontSize: '12px',
