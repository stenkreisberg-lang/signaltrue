        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="p-8 lg:p-10 rounded-2xl bg-primary/5 border-2 border-primary/30 mb-10">
            <p className="text-lg lg:text-xl text-foreground leading-relaxed text-center font-medium">
              <strong>Behavioral Drift Intelligence</strong> detects early system-level strain by
              observing how work actually happens across calendars, collaboration tools, and
              workflows.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-xl bg-card border border-border/50 text-center">
              ...
              <h3 className="font-display font-semibold text-foreground mb-2">Structural Action</h3>
              <p className="text-sm text-muted-foreground">
