...
export const questions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Slack or Google Chat", value: "slack-chat", score: 2 },
      { label: "Mix of async tools + Slack", value: "async-mix", score: 3 },
    ],
  },
  {
    id: 5,
...
export function calculateResult(totalScore: number): QuestionnaireResult {
  ...
  if (totalScore >= 26) {
    ...
    tierDescription = 'SignalTrue is designed exactly for organizations like yours. Your team structure, collaboration patterns, and current visibility gaps make you an ideal candidate for early-warning team health insights.';
  } else if (totalScore >= 18) {
    tier = 'good-fit';
    tierLabel = 'Good Fit';
    tierDescription = 'SignalTrue can help you catch team health risks before they turn costly. Your organization has the right conditions to benefit from proactive people analytics.';
  } else {
    tier = 'not-yet-fit';
    tierLabel = 'Not Yet a Fit';
    tierDescription = 'Based on your current setup, SignalTrue may not be the right solution yet. As your organization grows or your tooling evolves, we could be a great partner.';
  }
