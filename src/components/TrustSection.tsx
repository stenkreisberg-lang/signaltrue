        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-success/10 border border-success/20 mb-6">
              ...
              <span className="text-caption font-medium text-success">Privacy by architecture</span>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-10">
            <div className="p-6 rounded-container bg-card border border-border/50 text-center">
              <div className="p-3 rounded-container bg-success/10 w-fit mx-auto mb-4">
