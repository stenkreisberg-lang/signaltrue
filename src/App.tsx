...
const StandardsMethodology = lazy(() => import('./pages/StandardsMethodology'));
...
const DidControlWork = lazy(() => import('./pages/DidControlWork'));
          ...
          <BrowserRouter>
            ...
            >
              <Routes>
                ...
                <Route path="/standards" element={<StandardsMethodology />} />
                {[
