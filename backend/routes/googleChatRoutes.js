...
import {
  ...
  analyzeSpace,
  listSpaces,
} from '../services/googleChatService.js';
...
router.post('/google-chat/refresh', requireMasterAdmin, async (req, res) => {
  try {
...
router.get('/google-chat/spaces/:orgId', requireOrganizationAccess(), async (req, res) => {
  try {
...
router.post('/google-chat/analyze/:spaceId', requireOrganizationAccess(), async (req, res) => {
  try {
