...
router.get('/industry/:metric', checkBenchmarkAccess, async (req, res) => {
  try {
    ...
    // Fetch benchmark
    const benchmark = await IndustryBenchmark.getBenchmark(industry, companySizeBand, metric);
...
router.post('/industry/compare', checkBenchmarkAccess, async (req, res) => {
  try {
    ...
    for (const [metricKey, value] of Object.entries(metrics)) {
      const benchmark = await IndustryBenchmark.getBenchmark(industry, companySizeBand, metricKey);
