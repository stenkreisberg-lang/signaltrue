...
silenceRiskIndicatorSchema.pre('save', function () {
  ...
  if (this.baseline && this.baseline.asyncContributionCount) {
    const contributionChange =
      ((this.asyncContributionCount - this.baseline.asyncContributionCount) /
        this.baseline.asyncContributionCount) *
      100;
  ...
  if (this.baseline && this.baseline.uniqueCollaborators) {
    const networkChange =
      ((this.uniqueCollaborators - this.baseline.uniqueCollaborators) /
        this.baseline.uniqueCollaborators) *
      100;
  ...
  if (this.baseline && this.baseline.upwardResponseTimeHours) {
    const responseChange =
      ((this.upwardResponseTimeHours - this.baseline.upwardResponseTimeHours) /
        this.baseline.upwardResponseTimeHours) *
      100;
  ...
  if (this.baseline && this.baseline.sentimentVariance) {
    const varianceChange =
      ((this.sentimentVariance - this.baseline.sentimentVariance) /
        this.baseline.sentimentVariance) *
      100;
