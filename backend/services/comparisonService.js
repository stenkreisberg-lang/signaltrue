    ...
    const comparison = {
      ...
      metrics: {
        meetingLoad: {
          ...
          delta: (
            ((teamAvg.meetingLoadIndex - orgAvg.meetingLoadIndex) / orgAvg.meetingLoadIndex) *
            100
          ).toFixed(1),
        ...
        afterHoursRate: {
          ...
          delta: (
            ((teamAvg.afterHoursRate - orgAvg.afterHoursRate) / orgAvg.afterHoursRate) *
            100
          ).toFixed(1),
        ...
        responseLatency: {
          ...
          delta: (
            ((teamAvg.responseMedianMins - orgAvg.responseMedianMins) / orgAvg.responseMedianMins) *
            100
          ).toFixed(1),
        ...
        focusTime: {
          ...
          delta: (
            ((teamAvg.focusTimeRatio - orgAvg.focusTimeRatio) / orgAvg.focusTimeRatio) *
            100
          ).toFixed(1),
    ...
    const comparison = {
      ...
      metrics: {
        meetingLoad: {
          ...
          change: (
            ((thisMonthAvg.meetingLoadIndex - lastMonthAvg.meetingLoadIndex) /
              lastMonthAvg.meetingLoadIndex) *
            100
          ).toFixed(1),
          trend:
            thisMonthAvg.meetingLoadIndex > lastMonthAvg.meetingLoadIndex
        ...
        afterHoursRate: {
          ...
          change: (
            ((thisMonthAvg.afterHoursRate - lastMonthAvg.afterHoursRate) /
              lastMonthAvg.afterHoursRate) *
            100
          ).toFixed(1),
          trend:
            thisMonthAvg.afterHoursRate > lastMonthAvg.afterHoursRate ? 'increasing' : 'decreasing',
        },
        responseLatency: {
          current: thisMonthAvg.responseMedianMins,
          previous: lastMonthAvg.responseMedianMins,
          change: (
            ((thisMonthAvg.responseMedianMins - lastMonthAvg.responseMedianMins) /
              lastMonthAvg.responseMedianMins) *
            100
          ).toFixed(1),
          trend:
            thisMonthAvg.responseMedianMins > lastMonthAvg.responseMedianMins
        ...
        focusTime: {
          ...
          change: (
            ((thisMonthAvg.focusTimeRatio - lastMonthAvg.focusTimeRatio) /
              lastMonthAvg.focusTimeRatio) *
            100
          ).toFixed(1),
          trend:
            thisMonthAvg.focusTimeRatio > lastMonthAvg.focusTimeRatio ? 'increasing' : 'decreasing',
        },
      },
    };
