...
function analyzePostMeetingSignals(data) {
  ...
  return {
    ...
    decisionMade: {
      ...
      confidence:
        data.afterMeeting.actionKeywordCount > 10
          ? 'high'
          : data.afterMeeting.actionKeywordCount > 5
            ? 'medium'
            : 'low',
    },
  };
...
function generateRecommendations(positive, negative) {
  ...
  if (
    negative.repeatMeetingScheduled.detected &&
    negative.repeatMeetingScheduled.daysUntilRepeat < 3
  ) {
