...
export const defaultPlaybooks = [
  {
    ...
    action: {
      ...
      description:
        'Temporarily suspend standing meetings (except critical syncs) to create execution capacity',
      steps: [
    ...
    risk: {
      level: 'Low',
      description:
        'Low risk if critical syncs are maintained. May feel uncomfortable for first few days.',
      mitigations: [
    ...
    successIndicators: [
      ...
      {
        metric: 'Team Feedback',
        target: 'Positive sentiment on execution',
        measurement: '1-question survey',
      },
    ],
    examples: [
      {
...

  {
    ...
    expectedEffect: {
      description:
        'Increased uninterrupted focus time, reduced context switching, improved deep work capacity',
      metrics: [
    ...
    successIndicators: [
      {
        metric: 'Focus Blocks/Week',
        target: '≥ 8 blocks of 90+ min',
        measurement: 'Calendar analysis',
      },
      {
        metric: 'Interruptions',
        target: '< 8/day',
        measurement: 'Slack activity during focus time',
      },
      {
    ...
    successIndicators: [
      {
        ...
        target: '< 3 days for most decisions',
        measurement: 'Decision log timestamps',
      },
...

  {
    ...
    successIndicators: [
      ...
      {
        metric: 'Focus Block Interruptions',
        target: '< 3/day',
        measurement: 'Calendar + Slack overlap',
      },
    ],
    examples: [
      {
