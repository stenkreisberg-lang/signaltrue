  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        section: ['26px', { lineHeight: '1.25', letterSpacing: '-0.01em' }],
        display: ['40px', { lineHeight: '1.12', letterSpacing: '-0.02em' }],
      },
      colors: {
      ...
      backgroundImage: {
        ...
        glow: 'radial-gradient(circle, rgba(12, 107, 95, 0.08) 0%, transparent 70%)',
      },
      keyframes: {
        'slide-up': {
